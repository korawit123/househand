  ...
  return (
    ...
    <div className={`flex pt-15  text-white sticky `}>
        <div className='flex flex-1 justify-center'>
            <Link href="/#" className='text-2xl font-bold'>Househand</Link>
        </div>
        ...
        <div className='flex justify-center content-center text-2xl flex-1'>
            <Link className='font-medium' href="/#">Login</Link>
            <Link className='ml-10 bg-white py-1 px-3 rounded-full text-black font-medium' href="/#">Sing up</Link>
        </div>
    </div>
    </> 
  );
